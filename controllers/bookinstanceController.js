...
exports.bookinstance_delete_post = function(req, res) {
    // Delete the bookinstance using bookinstanceid
...
exports.bookinstance_update_get = function(req, res) {
    ...
    async.parallel({
        ...
        list_book: function(callback) {
            ...
            // Success.
            res.render('bookinstance_form', {title: 'Update BookInstance', book_list: results.list_book, bookinstance: results.bookinstance});
        });
